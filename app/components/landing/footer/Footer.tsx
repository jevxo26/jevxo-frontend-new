...
export default function Footer() {
  return (
    <footer className="w-full bg-[#030712] text-white pt-16 md:pt-20 relative overflow-hidden z-10 border-t border-gray-900">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-12">
          ...
          <div className="lg:col-span-4 flex flex-col items-start space-y-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              {/* Facebook */}
              <Link
                href="https://www.facebook.com/jevxo"
                target="_blank"
                aria-label="Facebook"
              ...
              {/* LinkedIn */}
              <Link
                href="https://www.linkedin.com/company/jevxo26/"
                aria-label="LinkedIn"
                target="_blank"
                className="w-9 h-9 rounded-lg bg-[#111827] border border-gray-800/80 flex items-center justify-center text-gray-300 hover:text-white hover:bg-blue-600 hover:border-blue-500 transition-all duration-300 shadow-xs"
              >
            ...
            <div className="space-y-4 text-sm text-[#94a3b8]">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-[#94a3b8] text-xs sm:text-sm mt-0.5">+880 1968-657353 - +880 1581782193</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-[#94a3b8] text-xs sm:text-sm mt-0.5">info@jevxo.com</div>
                </div>
              </div>
      ...
      {/* Giant Glowing Watermark "JEVXO" Section at the very bottom */}
      <div className="relative w-full h-[180px] sm:h-[260px] md:h-[320px] lg:h-[380px] flex items-end justify-center pb-4 sm:pb-8 md:pb-12 select-none z-0 overflow-hidden mt-4 border-none">
        {/* Strong Vibrant Blue Gradient background */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#0432ff] via-[#0432ff]/60 to-transparent" />

        <h1 className="relative z-10 text-[120px] sm:text-[200px] md:text-[260px] lg:text-[320px] font-black tracking-tighter leading-none text-white/10 mix-blend-overlay">
          JEVXO
        </h1>

        {/* Horizontal Scanlines / Streaks over the text for that digital look */}
        <div className="absolute inset-0 z-20 pointer-events-none bg-[linear-gradient(transparent_50%,rgba(0,0,0,0.15)_50%)] bg-[length:100%_6px]" />
      </div>
